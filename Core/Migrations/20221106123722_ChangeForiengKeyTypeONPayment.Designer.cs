...
namespace Core.Migrations
{
    ...
    [Migration("20221106123722_ChangeForiengKeyTypeONPayment")]
    partial class ChangeForiengKeyTypeONPayment
    {
            ...
            modelBuilder.Entity("Core.Entities.Invoice", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ReferenceNumber"), 1L, 1);
            ...
            modelBuilder.Entity("Core.Entities.StudentSubject", b =>
                {
                    ...
                    b.HasKey("StudentNumber", "SubjectCode", "SubjectCodeId");
            ...
            modelBuilder.Entity("Core.Entities.Subject", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("SubjectCodeId"), 1L, 1);
            ...
            modelBuilder.Entity("Core.Entities.Invoice", b =>
                {
                    b.HasOne("Core.Entities.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("Core.Entities.Invoice", "PaymentId");
