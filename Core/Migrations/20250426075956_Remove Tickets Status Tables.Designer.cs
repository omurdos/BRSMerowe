...
namespace Core.Migrations
{
    ...
    [Migration("20250426075956_Remove Tickets Status Tables")]
    partial class RemoveTicketsStatusTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Batch", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("BatchId"));
            ...
            modelBuilder.Entity("Core.Entities.CardFee", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("CardFeesId"));
            ...
            modelBuilder.Entity("Core.Entities.GetArchive", b =>
                {
                    ...
                    b.ToView("GetArchive", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.GetStdGrade", b =>
                {
                    ...
                    b.ToView("GetStdGrades", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.Program", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("ProgramId"));
            ...
            modelBuilder.Entity("Core.Entities.PushNotification", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Core.Entities.Registration", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("SlipId"));
            ...
            modelBuilder.Entity("Core.Entities.Resulttest", b =>
                {
                    ...
                    b.ToView("resulttest", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.SMSAccess", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("BlockCounts")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Student", b =>
                {
                    ...
                    b.Property<bool?>("CanEditPersonalPhoto")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("IsMedicallyFit")
                        .HasColumnType("bit");

                    b.Property<bool>("IsOwed")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsPersonalPhotoApproved")
                        .HasColumnType("bit");

                    b.Property<bool>("IsStudentCardBlocked")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Entities.Studentstemp", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("Serial"));
            ...
            modelBuilder.Entity("Core.Entities.TblSection", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("SectionId"));
            ...
            modelBuilder.Entity("Core.Entities.TicketStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("StatusNameA")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatusNameE")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entities.Device", b =>
                {
                    b.HasOne("Core.Entities.APIUser", "APIUser")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("Core.Entities.Ticket", b =>
                {
                    b.HasOne("Core.Entities.APIUser", "Owner")
                        .WithMany("Tickets")
                        .HasForeignKey("APIUserId");

                    b.HasOne("Core.Entities.TicketStatus", "TicketStatus")
                        .WithMany("Tickets")
