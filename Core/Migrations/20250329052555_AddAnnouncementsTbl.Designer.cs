...
namespace Core.Migrations
{
    ...
    [Migration("20250329052555_AddAnnouncementsTbl")]
    partial class AddAnnouncementsTbl
    {
            ...
            modelBuilder.Entity("Core.Entities.Announcement", b =>
                {
                    ...
                    b.Property<string>("DepartmentFacultyNumber")
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("DepartmentNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DepartmentNumber1")
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("FacultyNumber1")
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("FacultyNumber1");

                    b.HasIndex("ProgramId");

                    b.HasIndex("DepartmentFacultyNumber", "DepartmentNumber1");
            ...
            modelBuilder.Entity("Core.Entities.Batch", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<decimal>("BatchId"), 1L, 1);
            ...
            modelBuilder.Entity("Core.Entities.Announcement", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Department", "Department")
                        .WithMany("Announcements")
                        .HasForeignKey("DepartmentFacultyNumber", "DepartmentNumber1");
